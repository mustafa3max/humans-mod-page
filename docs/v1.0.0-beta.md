...
* **`[` (Left Bracket):** Moves the entity forward.
* **`;` (Semicolon):** Moves the entity backward.
* **`Y`:** Rotates the entity clockwise.
* **`T`:** Rotates the entity counter-clockwise.
...
#### 4. Model and Texture Customization
